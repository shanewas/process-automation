...
export default function SelectBotModal(props) {
     ...
     else if(Selectexisting)
     {
        ...
        return (
            ...
            <Button onClick={()=>{setCreateNew(true)}} className="mt-4 btn btn-primary ml-5 mr-5" type="submit" >Create New</Button>
            <Button onClick={()=>{setSelectexisting(true)}} className="mt-4 btn btn-primary ml-5 mr-5" type="submit" >Select Existing Bot</Button>
            </div>
            </Modal.Body>
